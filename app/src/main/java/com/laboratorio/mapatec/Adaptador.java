...
public class Adaptador extends BaseAdapter {
    ...
    public View getView(int posicion, View view, ViewGroup viewGroup) {
        ...
        if (vi == null) {
            ...
            // Utiliza el diseño item_event.xml solo si estás en la actividad "eventos"
            if (a instanceof eventos) {
        ...
        // Si estás en la actividad "eventos", establece el contenido del TextView textViewEventoInfo
        if (a instanceof eventos) {
            ...
            String eventoInfo = "Título: " + v.getTitulo() + "\n"
